...
class Seq2Seq(tf.keras.models.Model):
    ...
    def __init__(self, vocab_size, start_index=2, embed_dim=128, lstm_units=256):
        ...
        self.encoder_lstm1 = tf.keras.layers.LSTM(units=lstm_units, return_state=True,
                                                  return_sequences=True)
        self.encoder_lstm2 = tf.keras.layers.LSTM(units=lstm_units, return_state=True)
    ...
    def call(self, inputs, training=True, *args, **kwargs):
        ...
        outputs, hidden, cell = self.encoder_lstm1(e_e)
        _, hidden, cell = self.encoder_lstm2(outputs, initial_state=[hidden, cell])
        t_outputs = []
...
Epoch 1/10
313/313 [==============================] - 19s 42ms/step - loss: 1.1650 - acc: 0.6458
Epoch 2/10
313/313 [==============================] - 13s 42ms/step - loss: 0.4896 - acc: 0.8400
Epoch 3/10
313/313 [==============================] - 13s 42ms/step - loss: 0.1680 - acc: 0.9516
Epoch 4/10
313/313 [==============================] - 14s 43ms/step - loss: 0.0713 - acc: 0.9843
Epoch 5/10
313/313 [==============================] - 14s 43ms/step - loss: 0.0453 - acc: 0.9904
Epoch 6/10
313/313 [==============================] - 15s 49ms/step - loss: 0.0148 - acc: 0.9988
Epoch 7/10
313/313 [==============================] - 14s 45ms/step - loss: 0.0077 - acc: 0.9997
Epoch 8/10
313/313 [==============================] - 14s 44ms/step - loss: 0.0297 - acc: 0.9926
Epoch 9/10
313/313 [==============================] - 14s 44ms/step - loss: 0.0053 - acc: 0.9996
Epoch 10/10
313/313 [==============================] - 14s 44ms/step - loss: 0.0023 - acc: 1.0000
"""
